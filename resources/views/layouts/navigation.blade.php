            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('create permintaan stock')
                        <x-nav-link :href="route('barang.index')" :active="request()->routeIs('view.stock-barang')">
                            {{ __('ReStock Barang') }}
                        </x-nav-link>
                        @endcan @can('create stock barang')
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('brand.index')">
                                        {{ __('Brand') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('kategori.index')">
                                        {{ __('Kategori') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('satuan.index')">
                                        {{ __('Uom') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
